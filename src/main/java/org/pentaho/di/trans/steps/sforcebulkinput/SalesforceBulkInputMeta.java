...
{	
   ...
   public void loadXML(Node stepnode, List<DatabaseMeta> databases, Map<String, Counter> counters)
	...
	public String getXML()
	{
		...
		retval.append("    "+XMLHandler.addTagValue("max", rowMax));
	...
	private void readData(Node stepnode) throws KettleXMLException
	{
		try
		{
			...
			rowMax = XMLHandler.getTagValue(stepnode, "max");
		}
		catch(Exception e)
		{
	    ...
	    throws KettleException
	{
		try
		{
			...
			rowMax          = rep.getStepAttributeString(id_step, "max");
		...
		throws KettleException
	{
		try
		{
			...
			rep.saveStepAttribute(id_transformation, id_step, "max",           rowMax);
