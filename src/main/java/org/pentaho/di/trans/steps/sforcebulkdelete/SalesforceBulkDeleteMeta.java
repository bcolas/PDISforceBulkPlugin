...
@Step(id="SalesforceBulkDelete", i18nPackageName="org.pentaho.di.trans.steps.sforcebulkutils", name="SalesforceBulkDelete.TypeLongDesc", description="SalesforceBulkDelete.TypeTooltipDesc", categoryDescription="i18n:org.pentaho.di.trans.step:BaseStep.Category.Output", image="SFD.svg", documentationUrl="")
public class SalesforceBulkDeleteMeta extends BaseStepMeta implements StepMetaInterface {
 ...
 public SalesforceBulkDeleteMeta() {
 ...
 public Object clone() {
   SalesforceBulkDeleteMeta retval = (SalesforceBulkDeleteMeta) super.clone();
 ...
 public String getXML() {
   ...
   retval.append( "    " + XMLHandler.addTagValue( "targeturl", soapurl ) );
 ...
 private void readData( Node stepnode ) throws KettleXMLException {
   try {
     soapurl = XMLHandler.getTagValue( stepnode, "targeturl" );
 ...
 public void setDefault() {
   ...
   timeout = "60000";
   rowMax=new Integer(Integer.MAX_VALUE).toString();
 }
 ...
 public void readRep( Repository rep, IMetaStore metaStore, ObjectId id_step, List<DatabaseMeta> databases ) throws KettleException {
   try {
     soapurl = rep.getStepAttributeString( id_step, "targeturl" );
     ...
     throw new KettleException( BaseMessages.getString(
       PKG, "SalesforceBulkMeta.Error.ErrorReadingRepository" ), e );
   }
 }

 public void saveRep( Repository rep, IMetaStore metaStore, ObjectId id_transformation, ObjectId id_step ) throws KettleException {
   try {
     rep.saveStepAttribute( id_transformation, id_step, "targeturl", soapurl );
     ...
     throw new KettleException( BaseMessages.getString(
       PKG, "SalesforceBulkMeta.Error.ErrorSavingToRepository", "" + id_step ), e );
   }
 }
 ...
 public void check( List<CheckResultInterface> remarks, TransMeta transMeta, StepMeta stepMeta,
   ...
   if ( input.length > 0 ) {
     cr =
       new CheckResult( CheckResult.TYPE_RESULT_ERROR, BaseMessages.getString(
         PKG, "SalesforceBulkMeta.CheckResult.NoInputExpected" ), stepMeta );
   } else {
     cr =
       new CheckResult( CheckResult.TYPE_RESULT_OK, BaseMessages.getString(
         PKG, "SalesforceBulkMeta.CheckResult.NoInput" ), stepMeta );
   }
   remarks.add( cr );
   ...
   if ( Const.isEmpty( soapurl ) ) {
     cr =
       new CheckResult( CheckResult.TYPE_RESULT_ERROR, BaseMessages.getString(
         PKG, "SalesforceBulkMeta.CheckResult.NoURL" ), stepMeta );
   } else {
     cr =
       new CheckResult( CheckResult.TYPE_RESULT_OK, BaseMessages.getString(
         PKG, "SalesforceBulkMeta.CheckResult.URLOk" ), stepMeta );
   }
   remarks.add( cr );
   ...
   if ( Const.isEmpty( username ) ) {
     cr =
       new CheckResult( CheckResult.TYPE_RESULT_ERROR, BaseMessages.getString(
         PKG, "SalesforceBulkMeta.CheckResult.NoUsername" ), stepMeta );
   } else {
     cr =
       new CheckResult( CheckResult.TYPE_RESULT_OK, BaseMessages.getString(
         PKG, "SalesforceBulkMeta.CheckResult.UsernameOk" ), stepMeta );
   }
   remarks.add( cr );
   ...
   if ( Const.isEmpty( module ) ) {
     cr =
       new CheckResult( CheckResult.TYPE_RESULT_ERROR, BaseMessages.getString(
         PKG, "SalesforceBulkMeta.CheckResult.NoModule" ), stepMeta );
   } else {
     cr =
       new CheckResult( CheckResult.TYPE_RESULT_OK, BaseMessages.getString(
         PKG, "SalesforceBulkMeta.CheckResult.ModuleOk" ), stepMeta );
   }
   remarks.add( cr );
 ...
 public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr,
   ...
   return new SalesforceBulkDelete( stepMeta, stepDataInterface, cnr, transMeta, trans );
 }

 public StepDataInterface getStepData() {
   return new SalesforceBulkDeleteData();
 }
